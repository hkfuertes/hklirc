...
"""
import atexit, datetime, os, signal, sys, time
from hklirc import run

DAEMON_APP_NAME = "hklircd"
...
class Daemon(object):
    ...
    def __init__(self, pid_file,
                 stdout=LOG_FOLDER+DAEMON_APP_NAME+'_out.log',
                 stderr=LOG_FOLDER+DAEMON_APP_NAME+'_err.log'):   
        self.stdout = stdout
        self.stderr = stderr
...
if __name__ == '__main__':
    ...
    daemon = Daemon('/tmp/'+DAEMON_APP_NAME+'.pid')
    if 'start' == sys.argv[1]:
        daemon.start()
